...
6. In `submitNote`, use `querySelector` to grab a reference to the title input element.
```
function submitNote() {
...
12. Open the browser and test out the new functionality. You should be able to create new notecards from the note editor!
